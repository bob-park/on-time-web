    ...
    <div className="flex w-full flex-row gap-4">
      ...
      <div className="flex-1 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="mb-4 flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-slate-500">주간 근무 진척도</p>
            <p className="mt-1 text-3xl font-bold text-slate-900">
              {cumulativeHours}h<span className="ml-1 text-lg font-normal text-slate-400">/ {WEEKLY_TOTAL_HOURS}h</span>
            </p>
          </div>
          <span
      ...
      <div className="w-56 flex-none rounded-2xl border border-slate-200 bg-slate-50 p-6 shadow-sm">
        <p className="text-sm font-medium text-slate-500">보상휴가 잔여</p>
        <p className="mt-2 text-4xl font-bold text-slate-900">
          {overtimeBalanceHours >= 0 ? '+' : ''}
          {overtimeBalanceHours.toFixed(1)}
          <span className="ml-1 text-xl font-normal text-slate-400">h</span>
        </p>
        ...
        <div className="mt-6 flex items-center gap-2">
          <Link
            href="/dayoff/used"
            className="rounded-xl bg-slate-800 px-4 py-2 text-sm font-medium text-white transition-colors duration-150 hover:bg-slate-700"
          >
            사용 내역 보기
          </Link>
        </div>
